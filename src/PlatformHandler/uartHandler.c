...
void serial_info_init(UART_TypeDef *pUART, struct __serial_info *serial)
{
    ...
    uint32_t baud_table[] = {300, 600, 1200, 1800, 2400, 4800, 9600, 14400, 19200, 28800, 31250, 38400, 57600, 115200, 230400, 460800};
	...
	if(!valid_arg)
		UART_InitStructure.UART_BaudRate = baud_table[baud_31250];
